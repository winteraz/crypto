...
func (m *Manager) verify(ctx context.Context, client *acme.Client, domain string) error {
	...
	challengeTypes = append(challengeTypes, "tls-sni-02", "tls-sni-01")
	m.tokensMu.RLock()
	if m.tryHTTP01 {
	...
	for {
		...
		cleanup, err := m.fulfill(ctx, domain, client, chal)
		if err != nil {
			continue
		}
		defer cleanup()
...
func (m *Manager) fulfill(ctx context.Context, domain string, client *acme.Client, chal *acme.Challenge) (cleanup func(), err error) {
	switch chal.Type {
	case "dns-01":
